...
public class ContentBuilderUtil {
	...
	private static final Logger logger = LoggerFactory.getLogger(ContentBuilderUtil.class);
	...
	public static void addComplexField(XContentBuilder builder, String fieldName, XContentType contentType, byte[] data)
		...
		try {
			...
			logger.debug("addSimpleField finally");
		} finally {
			if (parser != null) {
				parser.close();
			}
