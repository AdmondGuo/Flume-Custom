...
public class FlumeApp {
  ...
  public FlumeApp(List<LifecycleAware> components) {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      System.out.println("param0 "+args[0]);
      System.out.println("param1 "+args[1]);
      System.out.println("param2 "+args[2]);
      System.out.println("param3 "+args[3]);
      ...
      if (isZkConfigured) {
        ...
        if (reload) {
          ...
          application = new FlumeApp(components);
          eventBus.register(application);
        } else {
          StaticZooKeeperConfigurationProvider zookeeperConfigurationProvider =
              new StaticZooKeeperConfigurationProvider(
                  agentName, zkConnectionStr, baseZkPath);
          application = new FlumeApp();
      ...
      final FlumeApp appReference = application;
